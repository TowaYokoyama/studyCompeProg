"""
AtCorder.ABC.415.D の Docstring
...
1 以上 M 以下の整数 i を選ぶ。コーラショップに A 
i
​	
  本の空き瓶を渡し、引き換えに B 
i
​	
  本の瓶入りコーラおよび記念のシール 1 枚をもらう。 （行動前に持っている空き瓶の本数が A 
i
​	
  未満であるような i は選ぶことができない。 選ぶことのできる i が存在しない場合、この行動は取れない。）
