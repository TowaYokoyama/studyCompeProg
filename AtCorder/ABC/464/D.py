...
ただし、 i 日目の天気を変更した場合、嬉しさが X 
i
​	
  減少する。
操作を行った後の最終的な天気に対して、以下の条件で嬉しさが増加します。

1≤i≤N−1 を満たす各整数 i について、変更後の i 日目の天気が雨、かつ i+1 日目の天気が晴れであるとき、嬉しさが Y 
i
​	
  増加する。
...
3 日目の天気を雨から晴れに変更する。嬉しさが X 
3
​	
 =4 減少し、各日の天気は 晴れ、雨、晴れ、雨、晴れ、雨 となります。
この操作の結果、 2 日目が雨、 3 日目が晴れであることから嬉しさが Y 
2
​	
 =6 増加し、 4 日目が雨、 5 日目が晴れであることから嬉しさが Y 
4
​	
 =3 増加します。
