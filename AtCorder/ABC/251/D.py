"""
AtCorder.ABC.251.D の Docstring
整数 W が与えられます。
...
i
​	
  を i 番目のおもりの重さとして、以下の形式で出力せよ。答えが複数存在する場合、どれを出力しても正解とみなされる。
...
"""
W = int(input())  # Wは実は使わなくてOK（制約上この構成で全部カバーできるため）

ans = []
for i in range(1, 100):
    ans.append(i)          # 1..99
    ans.append(i * 100)    # 100..9900
    ans.append(i * 10000)  # 10000..990000
