"""
AtCorder.ABC.424.B の Docstring
N 人の人が、M 問からなるプログラミングコンテストに参加しました。
参加者は人 1, 人 2, …, 人 N と番号づけられており、問題は問題 1, 問題 2, …, 問題 M と番号づけられています。

このコンテストでは K 個のイベントが順番に起き、i 番目 (1≤i≤K) のイベントでは次のことが起きました。
